...
#     def __init__(self):
#         self.hard_skill_keywords = ["python", "sql", "machine learning", "cloud computing"]
#         self.soft_skill_keywords = ["communication", "leadership", "problem-solving", "collaboration"]
...
#             category = "Hard" if any(kw in skill_lower for kw in self.hard_skill_keywords) else "Soft"
#             proficiency = self._assign_proficiency(skill_lower)
#             skill_obj = {"name": skill, "category": category, "proficiency": proficiency}
#             if category == "Hard":
